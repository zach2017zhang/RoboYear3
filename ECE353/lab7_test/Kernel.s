...
!   if intIsZero (_temp_1048) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   _temp_1050 = _temp_1048 + 32
	load	[r14+-196],r1
	add	r1,32,r1
	store	r1,[r14+-188]
!   _temp_1051 = _temp_1050 + 4
	load	[r14+-188],r1
	add	r1,4,r1
	store	r1,[r14+-184]
...
!   _temp_1056 = _temp_1052 XOR 0		(bool)
	...
	xor	r1,r2,r1
	storeb	r1,[r14+-15]
!   if _temp_1056 then goto _Label_1043 else goto _Label_1041
	loadb	[r14+-15],r1
	cmp	r1,0
	be	_Label_1041
	jmp	_Label_1043
...
!   _temp_1061 = _temp_1057 XOR 0		(bool)
	...
	xor	r1,r2,r1
	storeb	r1,[r14+-13]
!   if _temp_1061 then goto _Label_1042 else goto _Label_1041
	loadb	[r14+-13],r1
	cmp	r1,0
	be	_Label_1041
	jmp	_Label_1042
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if copiedSoFar != sizeInBytes then goto _Label_1063		(int)
	load	[r14+-280],r1
	load	[r14+16],r2
	cmp	r1,r2
	bne	_Label_1063
...
!   if intIsZero (_temp_1064) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   _temp_1066 = _temp_1064 + 124
	load	[r14+-156],r1
	add	r1,124,r1
	store	r1,[r14+-148]
!   Move address of _temp_1066 [fileDesc ] into _temp_1067
!     make sure index expr is >= 0
	load	[r14+8],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-144]
!   Data Move: openFile = *_temp_1067  (sizeInBytes=4)
	load	[r14+-144],r1
	load	[r1],r1
	store	r1,[r14+-300]
! ASSIGNMENT STATEMENT...
...
!   if intIsZero (openFile) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   _temp_1068 = openFile + 16
	load	[r14+-300],r1
	add	r1,16,r1
	store	r1,[r14+-140]
!   Data Move: nextPosInFile = *_temp_1068  (sizeInBytes=4)
	load	[r14+-140],r1
	load	[r1],r1
	store	r1,[r14+-284]
! ASSIGNMENT STATEMENT...
...
!   if intIsZero (_temp_1069) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   _temp_1071 = _temp_1069 + 24
	load	[r14+-136],r1
	add	r1,24,r1
	store	r1,[r14+-128]
!   Data Move: fileSize = *_temp_1071  (sizeInBytes=4)
	load	[r14+-128],r1
	load	[r1],r1
	store	r1,[r14+-292]
! WHILE STATEMENT...
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   _temp_1077 = nextPosInFile + currentChunkSize		(int)
	load	[r14+-284],r1
	load	[r14+-288],r2
	add	r1,r2,r1
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-124]
!   if _temp_1077 <= fileSize then goto _Label_1076		(int)
	load	[r14+-124],r1
	load	[r14+-292],r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   _temp_1080 = copiedSoFar + currentChunkSize		(int)
	load	[r14+-280],r1
	load	[r14+-288],r2
	add	r1,r2,r1
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-120]
!   if _temp_1080 <= sizeInBytes then goto _Label_1079		(int)
	load	[r14+-120],r1
	load	[r14+16],r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if currentChunkSize > 0 then goto _Label_1082		(int)
	load	[r14+-288],r1
	mov	0,r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if virtPage >= 0 then goto _Label_1087		(int)
	load	[r14+-272],r1
	mov	0,r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
!   if intIsZero (_P_Kernel_currentThread) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   _temp_1091 = _P_Kernel_currentThread + 4160
	set	_P_Kernel_currentThread,r1
	load	[r1],r1
	add	r1,4160,r1
	store	r1,[r14+-104]
...
!   if intIsZero (_temp_1090) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   _temp_1092 = _temp_1090 + 32
	load	[r14+-108],r1
	add	r1,32,r1
	store	r1,[r14+-100]
!   _temp_1093 = _temp_1092 + 4
	load	[r14+-100],r1
	add	r1,4,r1
	store	r1,[r14+-96]
!   Data Move: _temp_1089 = *_temp_1093  (sizeInBytes=4)
	load	[r14+-96],r1
	load	[r1],r1
	store	r1,[r14+-112]
!   _temp_1088 = _temp_1089 - 1		(int)
	load	[r14+-112],r1
	mov	1,r2
	sub	r1,r2,r1
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-116]
!   if virtPage <= _temp_1088 then goto _Label_1086		(int)
	load	[r14+-272],r1
	load	[r14+-116],r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
!   Send message IsValid
	...
	add	r2,36,r2
	call	r2
!   Retrieve Result: targetName=_temp_1094  sizeInBytes=1
	loadb	[r15],r1
	storeb	r1,[r14+-12]
!   _temp_1098 = _temp_1094 XOR 0		(bool)
	loadb	[r14+-12],r1
	mov	0,r2
	xor	r1,r2,r1
	storeb	r1,[r14+-11]
!   if _temp_1098 then goto _Label_1085 else goto _Label_1083
	loadb	[r14+-11],r1
	cmp	r1,0
	be	_Label_1083
	jmp	_Label_1085
...
!   Retrieve Result: targetName=_temp_1099  sizeInBytes=1
	loadb	[r15],r1
	storeb	r1,[r14+-10]
!   _temp_1103 = _temp_1099 XOR 0		(bool)
	loadb	[r14+-10],r1
	mov	0,r2
	xor	r1,r2,r1
	storeb	r1,[r14+-9]
!   if _temp_1103 then goto _Label_1084 else goto _Label_1083
	loadb	[r14+-9],r1
	cmp	r1,0
	be	_Label_1083
	jmp	_Label_1084
...
! ASSIGNMENT STATEMENT...
	...
	mov	2070,r13		! source line 2070
	mov	"\0\0SE",r10
!   _temp_1114 = &_P_Kernel_fileManager
	set	_P_Kernel_fileManager,r1
	store	r1,[r14+-28]
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if copiedSoFar != sizeInBytes then goto _Label_1116		(int)
	load	[r14+-280],r1
	load	[r14+16],r2
	cmp	r1,r2
	bne	_Label_1116
...
!   if intIsZero (openFile) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   _temp_1117 = openFile + 16
	load	[r14+-300],r1
	add	r1,16,r1
	store	r1,[r14+-24]
!   Data Move: *_temp_1117 = nextPosInFile  (sizeInBytes=4)
	load	[r14+-284],r1
	load	[r14+-24],r2
	store	r1,[r2]
! RETURN STATEMENT...
...
!	jmp	_Label_1203
_Label_1203:
!   if sizeInBytes >= 0 then goto _Label_1202		(int)
	load	[r14+16],r1
	mov	0,r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-216]
!   Data Move: openFile = *_temp_1214  (sizeInBytes=4)
	load	[r14+-216],r1
	load	[r1],r1
	store	r1,[r14+-284]
! ASSIGNMENT STATEMENT...
...
!   if intIsZero (openFile) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   _temp_1215 = openFile + 16
	load	[r14+-284],r1
	add	r1,16,r1
	store	r1,[r14+-212]
!   Data Move: nextPosInFile = *_temp_1215  (sizeInBytes=4)
	load	[r14+-212],r1
	load	[r1],r1
	store	r1,[r14+-268]
! ASSIGNMENT STATEMENT...
...
!   if intIsZero (_temp_1216) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   _temp_1218 = _temp_1216 + 24
	load	[r14+-208],r1
	add	r1,24,r1
	store	r1,[r14+-200]
!   Data Move: fileSize = *_temp_1218  (sizeInBytes=4)
	load	[r14+-200],r1
	load	[r1],r1
	store	r1,[r14+-276]
! WHILE STATEMENT...
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   _temp_1224 = nextPosInFile + currentChunkSize		(int)
	load	[r14+-268],r1
	load	[r14+-272],r2
	add	r1,r2,r1
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-196]
!   if _temp_1224 <= fileSize then goto _Label_1223		(int)
	load	[r14+-196],r1
	load	[r14+-276],r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   _temp_1227 = copiedSoFar + currentChunkSize		(int)
	load	[r14+-264],r1
	load	[r14+-272],r2
	add	r1,r2,r1
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-192]
!   if _temp_1227 <= sizeInBytes then goto _Label_1226		(int)
	load	[r14+-192],r1
	load	[r14+16],r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if currentChunkSize > 0 then goto _Label_1229		(int)
	load	[r14+-272],r1
	mov	0,r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if virtPage >= 0 then goto _Label_1234		(int)
	load	[r14+-256],r1
	mov	0,r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
!   Data Move: _temp_1235 = *_temp_1239  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-188]
!   if virtPage <= _temp_1235 then goto _Label_1233		(int)
	load	[r14+-256],r1
	load	[r14+-188],r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
!   _temp_1244 = _temp_1240 XOR 0		(bool)
	...
	xor	r1,r2,r1
	storeb	r1,[r14+-15]
!   if _temp_1244 then goto _Label_1232 else goto _Label_1230
	loadb	[r14+-15],r1
	cmp	r1,0
	be	_Label_1230
	jmp	_Label_1232
...
!   _temp_1249 = _temp_1245 XOR 0		(bool)
	...
	xor	r1,r2,r1
	storeb	r1,[r14+-13]
!   if _temp_1249 then goto _Label_1231 else goto _Label_1230
	loadb	[r14+-13],r1
	cmp	r1,0
	be	_Label_1230
	jmp	_Label_1231
...
!   if intIsZero (_P_Kernel_currentThread) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   _temp_1253 = _P_Kernel_currentThread + 4160
	set	_P_Kernel_currentThread,r1
	load	[r1],r1
	add	r1,4160,r1
	store	r1,[r14+-140]
!   Data Move: _temp_1252 = *_temp_1253  (sizeInBytes=4)
	load	[r14+-140],r1
	load	[r1],r1
	store	r1,[r14+-144]
!   if intIsZero (_temp_1252) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   _temp_1254 = _temp_1252 + 124
	load	[r14+-144],r1
	add	r1,124,r1
	store	r1,[r14+-136]
!   Move address of _temp_1254 [fileDesc ] into _temp_1255
!     make sure index expr is >= 0
	load	[r14+8],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-132]
!   Data Move: openFile = *_temp_1255  (sizeInBytes=4)
	load	[r14+-132],r1
	load	[r1],r1
	store	r1,[r14+-284]
! ASSIGNMENT STATEMENT...
...
!   if intIsZero (openFile) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   _temp_1256 = openFile + 16
	load	[r14+-284],r1
	add	r1,16,r1
	store	r1,[r14+-128]
!   Data Move: nextPosInFile = *_temp_1256  (sizeInBytes=4)
	load	[r14+-128],r1
	load	[r1],r1
	store	r1,[r14+-268]
! ASSIGNMENT STATEMENT...
...
!   if intIsZero (_temp_1257) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   _temp_1259 = _temp_1257 + 24
	load	[r14+-124],r1
	add	r1,24,r1
	store	r1,[r14+-116]
!   Data Move: fileSize = *_temp_1259  (sizeInBytes=4)
	load	[r14+-116],r1
	load	[r1],r1
	store	r1,[r14+-276]
! WHILE STATEMENT...
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   _temp_1265 = nextPosInFile + currentChunkSize		(int)
	load	[r14+-268],r1
	load	[r14+-272],r2
	add	r1,r2,r1
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-112]
!   if _temp_1265 <= fileSize then goto _Label_1264		(int)
	load	[r14+-112],r1
	load	[r14+-276],r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   _temp_1268 = copiedSoFar + currentChunkSize		(int)
	load	[r14+-264],r1
	load	[r14+-272],r2
	add	r1,r2,r1
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-108]
!   if _temp_1268 <= sizeInBytes then goto _Label_1267		(int)
	load	[r14+-108],r1
	load	[r14+16],r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if currentChunkSize > 0 then goto _Label_1270		(int)
	load	[r14+-272],r1
	mov	0,r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if virtPage >= 0 then goto _Label_1275		(int)
	load	[r14+-256],r1
	mov	0,r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
!   _temp_1280 = _temp_1278 + 32
	...
	add	r1,32,r1
	store	r1,[r14+-88]
!   _temp_1281 = _temp_1280 + 4
	load	[r14+-88],r1
	add	r1,4,r1
	store	r1,[r14+-84]
!   Data Move: _temp_1277 = *_temp_1281  (sizeInBytes=4)
	load	[r14+-84],r1
	load	[r1],r1
	store	r1,[r14+-100]
!   _temp_1276 = _temp_1277 - 1		(int)
	load	[r14+-100],r1
	mov	1,r2
	sub	r1,r2,r1
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-104]
!   if virtPage <= _temp_1276 then goto _Label_1274		(int)
	load	[r14+-256],r1
	load	[r14+-104],r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
!   _temp_1286 = _temp_1282 XOR 0		(bool)
	...
	xor	r1,r2,r1
	storeb	r1,[r14+-11]
!   if _temp_1286 then goto _Label_1273 else goto _Label_1271
	loadb	[r14+-11],r1
	cmp	r1,0
	be	_Label_1271
	jmp	_Label_1273
...
!   _temp_1291 = _temp_1287 XOR 0		(bool)
	...
	xor	r1,r2,r1
	storeb	r1,[r14+-9]
!   if _temp_1291 then goto _Label_1272 else goto _Label_1271
	loadb	[r14+-9],r1
	cmp	r1,0
	be	_Label_1271
	jmp	_Label_1272
...
! ASSIGNMENT STATEMENT...
	...
	mov	2162,r13		! source line 2162
	mov	"\0\0SE",r10
!   _temp_1299 = &_P_Kernel_fileManager
	set	_P_Kernel_fileManager,r1
	store	r1,[r14+-28]
!   Prepare Argument: offset=12  value=openFile  sizeInBytes=4
	load	[r14+-284],r1
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if copiedSoFar != sizeInBytes then goto _Label_1301		(int)
	load	[r14+-264],r1
	load	[r14+16],r2
	cmp	r1,r2
	bne	_Label_1301
...
!   if intIsZero (openFile) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   _temp_1302 = openFile + 16
	load	[r14+-284],r1
	add	r1,16,r1
	store	r1,[r14+-24]
!   Data Move: *_temp_1302 = nextPosInFile  (sizeInBytes=4)
	load	[r14+-268],r1
	load	[r14+-24],r2
	store	r1,[r2]
! RETURN STATEMENT...
