...
# Part 8_1
# -----------------------------------------------------------------------------
def imdl(source_file_name,folder_name,folder_name2):
...
def get_faces():
    ...
    imdl("facescrub_actors.txt","actors_uncropped/","cropped_images/")
    imdl("facescrub_actresses.txt","actresses_uncropped/","cropped_images/")
